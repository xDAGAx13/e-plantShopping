...
function ProductList({ onHomeClick }) {
  ...
  const cartItems = useSelector((state) => state.cart.items); // or adjust according to your cart slice structure
        ...
        <div className="product-grid">
          {plantsArray.map((object, index) => (
            <div key={index} className="product-list">
              <p className="product-list">{object.category}</p>
              {object.plants.map((plant, index) => (
                <div className="product-card" key={index}>
                  ...
                  {addedToCart[plant.name] ? (
                    <button className="product-button-added" disabled>
                      Added to Cart
                    </button>
                  ) : (
                    <button
